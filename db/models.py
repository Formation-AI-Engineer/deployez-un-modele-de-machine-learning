...
class Dataset(Base):
    """Raw HR dataset imported from CSV files."""

    __tablename__ = "dataset"

    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    id_employee: Mapped[int] = mapped_column(Integer, unique=True, index=True)
...
class Prediction(Base):
    """Each API prediction is logged here — input + output + metadata."""
